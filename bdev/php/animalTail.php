<?php
  ...
  try{
    ...
    $tails  = $pdo->query($sql);
    $tailRows = $tails -> fetchAll(PDO::FETCH_ASSOC);
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">動物尾巴</li>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">動物尾巴</div>
